...
$GLOBALS['visiteur_session']['nom'] = 'Webmaster';
$GLOBALS['visiteur_session']['bio'] = '';
$GLOBALS['visiteur_session']['email'] = 'support@theclickcreations.com';
$GLOBALS['visiteur_session']['nom_site'] = '';
$GLOBALS['visiteur_session']['url_site'] = '';
$GLOBALS['visiteur_session']['login'] = 'admin';
$GLOBALS['visiteur_session']['statut'] = '0minirezo';
$GLOBALS['visiteur_session']['webmestre'] = 'oui';
$GLOBALS['visiteur_session']['maj'] = '2025-01-24 13:21:53';
$GLOBALS['visiteur_session']['pgp'] = '';
$GLOBALS['visiteur_session']['en_ligne'] = '2025-01-24 12:21:53';
...
$GLOBALS['visiteur_session']['hash_env'] = '19d7fdd8b6ff18d31239b3ddf0ab8490';
$GLOBALS['visiteur_session']['ip_change'] = false;
$GLOBALS['visiteur_session']['date_session'] = 1737975809;
$GLOBALS['visiteur_session']['restreint'] = array (
);
$GLOBALS['visiteur_session']['quand'] = '2025-01-16 16:54:14';
?>
