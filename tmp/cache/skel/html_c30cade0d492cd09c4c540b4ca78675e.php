...
function BOUCLE_objetshtml_c30cade0d492cd09c4c540b4ca78675e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = Spip\Compilateur\Iterateur\Factory::create(
		"DATA",
		$command,
		array('../prive/themes/spip/lists.css.html','html_c30cade0d492cd09c4c540b4ca78675e','_objets',196,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
(($t1 = strval(retablir_echappements_modeles(chemin_image((string)(interdire_scripts(concat(safehtml(table_valeur($Pile[$SP]['valeur'], 'icone_objet')),'-24.png')))))))!=='' ?
	...
	padding-' .
	retablir_echappements_modeles(interdire_scripts(safehtml((isset($Pile[$SP]['left'])?$Pile[$SP]['left']:(($Pile[0]['left'] ?? null)))))) .
...
function BOUCLE_objets2html_c30cade0d492cd09c4c540b4ca78675e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = Spip\Compilateur\Iterateur\Factory::create(
		"DATA",
		$command,
		array('../prive/themes/spip/lists.css.html','html_c30cade0d492cd09c4c540b4ca78675e','_objets2',990,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
// Temps de compilation total: 3.729 ms
//

function html_c30cade0d492cd09c4c540b4ca78675e($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
' .
BOUCLE_objetshtml_c30cade0d492cd09c4c540b4ca78675e($Cache, $Pile, $doublons, $Numrows, $SP) .
'
/* pour editer liens ? */
...
' .
BOUCLE_objets2html_c30cade0d492cd09c4c540b4ca78675e($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
');
	...
	return analyse_resultat_skel('html_c30cade0d492cd09c4c540b4ca78675e', $Cache, $page, '../prive/themes/spip/lists.css.html');
}
