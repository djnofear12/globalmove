...
return [
	...
	'bouton_afficher' => 'عرض',
	'bouton_afficher_plugins_coches' => 'الملحقات المحددة',
	'bouton_afficher_plugins_forces' => 'الملحقات ذات التوافقية المفروضة',
	'bouton_afficher_plugins_incompatibles' => 'الملحقات غير المتوافقة',
	'bouton_afficher_plugins_maj' => 'الملحقات التي لديها تحديثات',
	'bouton_afficher_plugins_tout' => 'كل الملحقات',
	'bouton_annuler_filtres' => 'إزالة المرشحات',
...
<strong>يجب إنشاؤه للتمكن من تثبيت ملحقات جديدة من هذه الواجهة.</strong>',
	...
	'erreur_password_incorrect' => 'كلمة سر غير صحيحة',
...
او العودة الى <a href="http://programmer.spip.net/repertoire_plugins-dist">التوثيق</a>.',
	...
	'info_fichier_depot' => 'إدخال عنوان URL العائد لملف وصف المستودع المطلوب إضافته.<br />لإضافة المستودع «git.spip.net - extensions»، النقر على الرابط:',
