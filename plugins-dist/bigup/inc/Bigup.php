...
class Bigup {
	...
	**/
	 ...
	 * est géré par Bigup (si on lui demande)
	 */
	...
	public function creer_jeton_retrouver_fichiers(): string {
		return $this->identifier->generer_token_champ('*');
	}

	public function verifier_jeton_retrouver_fichiers(string $token): bool {
		return $this->identifier->verifier_un_token($token);
	}
}
