...
return [
	...
	'bouton_radio_enregistrement_obligatoire' => 'Задължителна регистрация (преди да можете да участвате, необходимо е да се абонирате като запишете електронния си адрес).', # MODIF
 ...
 администраторите могат да ги изтриват).', # MODIF
 ...
 случаи за статиите, а забранени за рубриките, новините и др.',
	'info_envoi_forum' => 'Изпращане на форумите до авторите на статии', # MODIF
  ...
  по електронна поща за това. Искате ли да използвате тази възможност?', # MODIF
	...
	'item_activer_forum_administrateur' => 'Позволяване на администраторски форум', # MODIF
	'item_desactiver_forum_administrateur' => 'Без администраторски форум', # MODIF
	...
	// T
	'titre_cadre_forum_administrateur' => 'Затворен форум за администратори', # MODIF
