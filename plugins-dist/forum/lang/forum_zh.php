...
如果你您尚未注册, 您必须',
 ...
 公共论坛只能通过一篇一篇文章的访问;
它们的专栏和简要等将被禁止.',
	'info_envoi_forum' => '发送论坛给文章作者 ', # MODIF
  ...
  . 你愿意用这个选项吗?', # MODIF
	...
	'item_activer_forum_administrateur' => '激活管理者论坛', # MODIF
	'item_desactiver_forum_administrateur' => '使管理论坛不可用', # MODIF
	...
	// T
	'titre_cadre_forum_administrateur' => '管理者私有论坛', # MODIF
