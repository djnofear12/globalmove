...
return [
	...
	'bouton_radio_enregistrement_obligatoire' => 'Kayıt zorunlu (kullanıcılar katılabilmek için önceden e-posta adreslerini vererek kayıt olmalı).', # MODIF
...
önce kaydolmanız gerekmektedir.
 ...
 Eğer kaydolmamışsanız, yapmanız gereken',
	...
	'info_config_forums_prive_admin' => 'Site yöneticilierine ayrılmış bir forum :', # MODIF
	'info_config_forums_prive_global' => 'Tüm yazarlara açık genel forum :', # MODIF
	...
	'info_envoi_forum' => 'Forumların makale yazarlarına gönderilmesi', # MODIF
	...
	'info_option_email' => 'Bir ziyaretçi bir makaleye bağlı bir forumda yeni bir ileti gönderdiğinde,
           ...
           Her bir forum için bu seçeneği kullanmak isteyip istemediğinizi belirtiniz.', # MODIF
	...
	'item_activer_forum_administrateur' => 'Yöneticiler forumunun etkinleştirilmesi', # MODIF
	'item_config_forums_prive_global' => 'Yazarlar forumunu aktive et', # MODIF
	'item_config_forums_prive_objets' => 'Şu forumları aktive et',
	'item_desactiver_forum_administrateur' => 'Yönetici forumunu iptal et.', # MODIF
	'item_non_config_forums_prive_global' => 'Yazarlar forumunu dezaktive et', # MODIF
	...
	'titre_cadre_forum_administrateur' => 'Yöneticiler için özel forum', # MODIF
