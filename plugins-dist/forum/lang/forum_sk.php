...
return [
	...
	'bouton_radio_enregistrement_obligatoire' => 'Vyžaduje sa registrácia (používatelia sa musia zaregistrovať uvedením svojej e-mailovej adresy predtým, ako budú môcť posielať príspevky).', # MODIF
 ...
 ich môžu potom odstrániť).', # MODIF
	...
	'forum_info_modere' => 'Toto diskusné fórum sa kontroluje pred zverejnením: váš príspevok sa zobrazí až potom, čo ho potvrdí administrátor stránky.', # MODIF
 ...
 Prosím, zadajte svoj osobný identifikátor.
  ak ste sa ešte nezaregistrovali, musíte',
	...
	'info_config_forums_prive_admin' => 'Diskusné fórum vyhradené pre administrátorov:', # MODIF
	'info_config_forums_prive_global' => 'Globálne diskusné fórum otvorené všetkým autorom:', # MODIF
 ...
 pri článkoch; budú zakázané pre rubriky, novinky a pod.',
	'info_envoi_forum' => 'Posielať príspevky z diskusného fóra príslušným autorom', # MODIF
	...
	'info_option_email' => 'Keď návštevník pošle príspevok do diskusného fóra článku, autor článku môže byť o tom informovaný e-mailom. Pre každý typ diskusného fóra uveďte, či sa má táto možnosť aktivovať.', # MODIF
	'info_pas_de_forum' => 'žiadne diskusné fórum',
	'info_question_visiteur_ajout_document_forum' => 'Ak chcete povoliť návštevníkom pripájať súbory (obrázky, zvuky a i.) k diskusným príspevkom, určte, ktoré prípony súborov budú akceptované (napr. gif, jpg, png, mp3).', # MODIF
	...
	'item_activer_forum_administrateur' => 'Povoliť diskusné fórum administrátorov', # MODIF
	'item_config_forums_prive_global' => 'Aktivovať diskusné fórum autorov', # MODIF
	'item_config_forums_prive_objets' => 'Aktivovať tieto diskusné fóra',
	'item_desactiver_forum_administrateur' => 'Deaktivovať diskusné fórum administrátorov', # MODIF
	'item_non_config_forums_prive_global' => 'Deaktivovať diskusné fórum autorov', # MODIF
	...
	'messages_meme_auteur' => 'Všetky príspevky od tohto autora', # MODIF
	...
	'messages_privadm' => 'Administrátori', # MODIF
	...
	'titre_cadre_forum_administrateur' => 'Súkromné diskusné fórum administrátorov', # MODIF
