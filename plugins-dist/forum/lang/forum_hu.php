...
return [
	...
	'bouton_radio_enregistrement_obligatoire' => 'Beíratkozás kötelező (a felhasználóknak be kell iratkozniuk azzal, hogy adják email címüket mielőbb küldhessenek anyagokat).', # MODIF
 ...
 (a küldött anyagok már küldéskor megjelennek, az adminisztrátorok későb tudják törölni).', # MODIF
...
amit kapott. Amennyiben nincs regisztrálva, akkor',
 ...
 a cikkeknél ; tiltva lesznek a rovatoknál, híreknél, stb.',
	'info_envoi_forum' => 'Fórumok küldése a cikkek szerzőinek', # MODIF
  ...
  akkor a szerzők erről az üzenetről értesülhetnek emailen. Szeretne használni ezt az opciót ?', # MODIF
	...
	'item_activer_forum_administrateur' => 'Admninisztrátori fórum aktiválása', # MODIF
	'item_desactiver_forum_administrateur' => 'Az adminisztrátori fórumok inaktiválása', # MODIF
	...
	// T
	'titre_cadre_forum_administrateur' => 'Privát adminisztrátori fórum', # MODIF
