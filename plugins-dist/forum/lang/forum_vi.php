...
return [
	...
	'bouton_radio_enregistrement_obligatoire' => 'Phải ghi danh (độc giả phải ghi tên và cho địa chỉ email trước khi gửi thư tín vào diễn đàn).', # MODIF
	...
	'bouton_radio_publication_immediate' => 'Phát hành thư tín ngay lập tức (thư gửi đi sẽ hiện lên ngay, quản trị viên có thể xóa chúng sau đó).', # MODIF
	...
	'info_envoi_forum' => 'Gửi thư tín diễn đàn đến tác giả bài viết', # MODIF
	...
	'item_activer_forum_administrateur' => 'Mở diễn đàn quản trị', # MODIF
	'item_desactiver_forum_administrateur' => 'Khóa diễn đàn quản trị viên', # MODIF
	...
	// T
	'titre_cadre_forum_administrateur' => 'Diễn đàn dành riêng cho quản trị viên', # MODIF
