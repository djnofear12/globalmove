...
return [
	...
	'bouton_radio_enregistrement_obligatoire' => 'Povinná registrace (uživatelé se musí nejprve přihlásit zadáním své elektronické adresy a teprve potom mohou zasílat své příspěvky).', # MODIF
 ...
 správci je mohou odstranit dodatečně).', # MODIF
...
. Tyto skupiny bude možno zapnout ad hoc
 u jednotlivých článků; budou zakázány u sekcí, novinek atd.',
	'info_envoi_forum' => 'Zasílání diskusních skupin autorům článků', # MODIF
  ...
  jejich článku. Chcete tuto možnost použít?', # MODIF
	...
	'item_activer_forum_administrateur' => 'Zapnout diskusní skupinu správců', # MODIF
	'item_desactiver_forum_administrateur' => 'Vypnout diskusní skupinu správců', # MODIF
	...
	// T
	'titre_cadre_forum_administrateur' => 'Soukromá diskusní skupina správců', # MODIF
