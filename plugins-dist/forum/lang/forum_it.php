...
return [
	...
	'bouton_radio_enregistrement_obligatoire' => 'Registrazione obbligatoria (gli utenti devono abbonarsi fornendo il loro indirizzo email prima di poter inviare contributi).', # MODIF
...
cancellarli successivamente).', # MODIF
...
che ti è stato fornito.  Se non sei registrato, devi',
	...
	'info_config_forums_prive_admin' => 'Un forum riservato agli amministratori del sito:', # MODIF
	'info_config_forums_prive_global' => 'Un forum globale, aperto a tutti i redattori:', # MODIF
...
sui singoli articoli; saranno invece proibiti nelle rubriche, nelle brevi, ecc',
	'info_envoi_forum' => 'Notifica dei forum agli autori degli articoli', # MODIF
	...
	'info_option_email' => 'Quando un visitatore del sito inserisce un nuovo messaggio nel forumassociato a un articolo, gli autori di quest’ultimo possono essereavvertiti via email. Per ogni tipo di forum, indica se desideri utilizzare quest’opzione.', # MODIF
	...
	'item_activer_forum_administrateur' => 'Attiva il forum degli amministratori', # MODIF
	'item_config_forums_prive_global' => 'Attiva i forum dei redattori', # MODIF
	'item_config_forums_prive_objets' => 'Attiva questi forum',
	'item_desactiver_forum_administrateur' => 'Disattiva il forum degli amministratori', # MODIF
	'item_non_config_forums_prive_global' => 'Disattiva i forum dei redattori', # MODIF
	...
	'messages_meme_auteur' => 'Tutti i messaggi di questo autore', # MODIF
	...
	'messages_privadm' => 'Amministratori', # MODIF
	...
	'titre_cadre_forum_administrateur' => 'Forum privato degli amministratori', # MODIF
