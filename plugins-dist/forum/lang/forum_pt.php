...
utilizadores devem ter uma assinatura ao fornecer o seu endereço e-mail antes de
 poderem enviar contribuições).', # MODIF
	'bouton_radio_moderation_priori' => 'Pré-moderação (as contribuições aparecem publicamente só depois da validação pelos administradores). ', # MODIF
 ...
 (as contribuições afixam-se logo que são enviadas, os administradores podem suprimi-las depois).', # MODIF
	...
	'forum_forum' => 'fórum',
	'forum_info_modere' => 'Este fórum é moderado antes da publicação : a sua contribuição só aparecerá depois de ser validada por um administrador do sítio.', # MODIF
 ...
 fornecido. Se não está registado, deve  ',
  ...
  de moderação por defeito </i>',
	...
	'info_config_forums_prive_admin' => 'Um fórum reservado aos administradores do sítio :', # MODIF
	'info_config_forums_prive_global' => 'Um fórum global, aberto a todos os autores:', # MODIF
 ...
 nos artigos ; serão proibidos nas rubricas, notícias, etc.',
	'info_envoi_forum' => 'Envio dos fóruns aos autores dos artigos', # MODIF
 ...
 ligado a um artigo, os autores do artigo podem ser informados por e-mail. Deseja activar essa opção ?', # MODIF
	'info_pas_de_forum' => 'não há fórum',
	'info_question_visiteur_ajout_document_forum' => 'Se pretende autorizar os vistantes a anexar ficheiros (de imagem, som...) às suas mensagens de fórum, indique que extensões de ficheiro são autorizadas (ex: gif, jpg, png, mp3).', # MODIF
	...
	'item_activer_forum_administrateur' => 'Activar o fórum dos administradores', # MODIF
	'item_config_forums_prive_global' => 'Activar o fórum dos autores', # MODIF
	'item_config_forums_prive_objets' => 'Activar estes fóruns',
	'item_desactiver_forum_administrateur' => 'Desactivar o fórum dos administradores', # MODIF
	'item_non_config_forums_prive_global' => 'Desactivar o fórum dos autores', # MODIF
	...
	'messages_meme_auteur' => 'Todas as mensagens deste autor', # MODIF
	...
	'titre_cadre_forum_administrateur' => 'Fórum privado dos administradores', # MODIF
