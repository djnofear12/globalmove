...
return [
	...
	'bouton_radio_enregistrement_obligatoire' => 'Krav på registrering (användare måste registrera sig genom att tillhandahålla sin e-postadress innan de kan bidra).  being able to post contributions).', # MODIF
	...
	'bouton_radio_publication_immediate' => 'Omedelbar publicering av meddelanden (bidrag visas direkt efter att de skickas, administratörer kan radera dom senare):', # MODIF
 ...
 enskilda artiklar; de kommer inte att vara aktiva för avdelningae, nyheter, osv.',
	'info_envoi_forum' => 'Skicka foruminlägg till artikelredaktörerna', # MODIF
	...
	'item_activer_forum_administrateur' => 'Aktivera administratörernas forum', # MODIF
	'item_config_forums_prive_global' => 'Aktivera redaktörernas forum', # MODIF
	'item_config_forums_prive_objets' => 'Aktivera dessa forum',
	'item_desactiver_forum_administrateur' => 'Avaktivera administratörernas forum', # MODIF
	'item_non_config_forums_prive_global' => 'Avaktivera redaktörernas forum', # MODIF
	...
	// T
	'titre_cadre_forum_administrateur' => 'Administratörernas privata forum ', # MODIF
