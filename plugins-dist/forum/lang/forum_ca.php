...
return [
	...
	'bouton_radio_enregistrement_obligatoire' => 'Enregistrament obligatori (els usuaris s’han d’inscriure facilitant la seva adreça electrònica abans de poder afegir les seves contribucions).', # MODIF
 ...
 lloc).', # MODIF
	...
	'bouton_radio_publication_immediate' => 'Publicació immediata dels missatges (es poden suprimir posteriorment des de l’administració). ', # MODIF
...
Si ja n’esteu, escriviu a continuació l’identifcador que us ha estat proporcionat. Si encara no ho heu fet, heu d’',
 ...
 de moderació per defecte:</i>', # MODIF
	...
	'info_config_forums_prive_admin' => 'Un fòrum reservat als administradors del lloc:', # MODIF
	'info_config_forums_prive_global' => 'Un fòrum global, obert a tots els redactors:', # MODIF
  ...
  estaran prohibits a les seccions, breus, etc.',
	'info_envoi_forum' => 'Enviar els fòrums als autors dels articles', # MODIF
	...
	'info_option_email' => 'Quan un visitant del lloc envia un nou missatge al fòrum associat a un article, els autors de l’article poden ser informats d’aquest missatge per correu electrònic. Indiqueu per cada tipus de fòrum si és necessari utilitzar aquesta opció.', # MODIF
	...
	'item_activer_forum_administrateur' => 'Activar el fòrum dels administradors', # MODIF
	'item_config_forums_prive_global' => 'Activar el fòrum dels redactors', # MODIF
	'item_config_forums_prive_objets' => 'Activar aquests fòrums',
	'item_desactiver_forum_administrateur' => 'Desactivar el fòrum dels administradors', # MODIF
	'item_non_config_forums_prive_global' => 'Desactivar el fòrum dels redactors', # MODIF
	...
	'titre_cadre_forum_administrateur' => 'Fòrum privat dels administradors', # MODIF
