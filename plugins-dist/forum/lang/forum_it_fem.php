...
return [
	...
	'bouton_radio_enregistrement_obligatoire' => 'Registrazione obbligatoria (le utenti devono abbonarsi fornendo il loro indirizzo email prima di poter inviare contributi).', # MODIF
...
di moderazione predefinito:</i>', # MODIF
	...
	'info_config_forums_prive_admin' => 'Un forum riservato alle amministratrici del sito:', # MODIF
	'info_config_forums_prive_global' => 'Un forum globale, aperto a tutte le redattrici:', # MODIF
...
sui singoli articoli; saranno invece proibiti nelle rubriche, nelle brevi, ecc',
	'info_envoi_forum' => 'Notifica dei forum alle autrici degli articoli', # MODIF
...
avvertite via email. Per ogni tipo di forum, indica se desideri utilizzare quest’opzione.', # MODIF
	...
	'item_activer_forum_administrateur' => 'Attiva il forum delle amministratrici', # MODIF
	'item_config_forums_prive_global' => 'Attiva i forum delle redattrici', # MODIF
	'item_config_forums_prive_objets' => 'Attiva questi forum',
	'item_desactiver_forum_administrateur' => 'Disattiva il forum delle amministratrici', # MODIF
	'item_non_config_forums_prive_global' => 'Disattiva i forum delle redattrici', # MODIF
	...
	'titre_cadre_forum_administrateur' => 'Forum privato delle amministratrici', # MODIF
