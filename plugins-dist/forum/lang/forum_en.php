...
return [
	...
	'bouton_radio_moderation_priori' => 'Pre-moderation (contributions will be shown only after validation by admins).',
 ...
 (contributions will be shown as soon as they are sent, admins can
 then delete them if necessary).',
	...
	'forum_envoyer' => 'Send',
	'forum_forum' => 'forum',
	'forum_info_modere' => 'This forum is pre-moderated: your contribution will only appear after being validated by an admin.',
...
. If you have not yet registered, you must',
	...
	'info_config_forums_prive_admin' => 'A forum reserved for the site admins:',
	'info_config_forums_prive_global' => 'A global forum, open to all the editors:',
 ...
 basis for articles; they will be permanently disabled for sections, news, etc.',
	...
	'info_option_email' => 'When a new message is posted to the forum of an article, the article’s author(s) can be informed of this by email. Indicate for each type of forum if this option should be activated.',
	...
	// M
	'messages_aucun' => 'None',
	'messages_meme_auteur' => 'All posts by this person',
	...
	'titre_cadre_forum_administrateur' => 'Admins’ private forum',
