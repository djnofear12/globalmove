...
return [
	...
	'bouton_radio_enregistrement_obligatoire' => 'Потрібна реєстрація.  (Користувачі повинні зареєструватися, направивши свої електронні адреси до того, як зможуть розмістити внески).', # MODIF
	'bouton_radio_moderation_priori' => 'Премодерація (Внески  будуть відображатися публічно тільки після перевірки адміністраторами).', # MODIF
	...
	'bouton_radio_publication_immediate' => 'Публікація коментарів без перевірки  (адміністратори можуть   видалити їх).', # MODIF
	...
	'forum_forum' => 'форум',
	'forum_info_modere' => 'На цьому форумі здійснюється премодерація: ваш коментар буде опубліковано після перевірки адміністратором.', # MODIF
	...
	'info_config_forums_prive_admin' => 'Форум для адміністраторів сайту:', # MODIF
	'info_config_forums_prive_global' => 'Форум, відкритий для всіх редакторів:', # MODIF
	...
	'info_envoi_forum' => 'Відправка форумів авторам статей', # MODIF
	...
	'info_option_email' => 'Коли відвідувач сайту розміщує нове повідомлення у форумі, пов’язаному зі статтею, автори статті можуть отримувати повідомлення про це електронною поштою. Будь ласка, вкажіть для яких випадків використовувати цю опцію.', # MODIF
	'info_pas_de_forum' => 'відключити форуми',
	'info_question_visiteur_ajout_document_forum' => 'Якщо ви дозволяєте відвідувачам додавати файли (документи, зображення, звуки...) до їхніх повідомлень на форумі, вкажіть нижче список дозволених розширень для файлів (наприклад, GIF, JPG, PNG, MP3).', # MODIF
	...
	'item_activer_forum_administrateur' => 'Увімкнути форум адміністраторів', # MODIF
	'item_config_forums_prive_global' => 'Увімкнути форум авторів', # MODIF
	'item_config_forums_prive_objets' => 'Увімкнути ці форуми',
	'item_desactiver_forum_administrateur' => 'Вимкнути форум адміністраторів', # MODIF
	'item_non_config_forums_prive_global' => 'Вимкнути форум авторів', # MODIF
	...
	// M
	'messages_aucun' => 'Нема',
	'messages_meme_auteur' => 'Усі коментарі цього автора', # MODIF
	...
	'messages_privadm' => 'Адміністратори', # MODIF
	...
	'titre_cadre_forum_administrateur' => 'Форум адміністраторів', # MODIF
