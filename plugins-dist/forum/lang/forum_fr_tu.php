...
return [
	...
	'bouton_radio_enregistrement_obligatoire' => 'Enregistrement obligatoire (les utilisateurs doivent s’abonner en fournissant leur adresse email avant de pouvoir poster des contributions).', # MODIF
	'bouton_radio_moderation_priori' => 'Modération a priori (les contributions ne s’affichent publiquement qu’après validation par les administrateurs).', # MODIF
	...
	'info_config_forums_prive_admin' => 'Un forum réservé aux administrateurs du site :', # MODIF
	'info_config_forums_prive_global' => 'Un forum global, ouvert à tous les rédacteurs :', # MODIF
	...
	'info_envoi_forum' => 'Envoi des forums aux auteurs des articles', # MODIF
	...
	'info_option_email' => 'Lorsqu’un visiteur du site poste un nouveau message dans le forum associé à un article, les auteurs de l’article peuvent être prévenus de ce message par email. Indiquer pour chaque type de forum s’il faut utiliser cette option.', # MODIF
	'info_pas_de_forum' => 'pas de forum',
	'info_question_visiteur_ajout_document_forum' => 'Si tu souhaites autoriser les visiteurs à joindre des documents (images, sons…) à leurs messages de forum, indique ci-dessous la liste des extensions de documents autorisés pour les forums (ex : gif, jpg, png, mp3).', # MODIF
	...
	'item_activer_forum_administrateur' => 'Activer le forum des administrateurs', # MODIF
	'item_config_forums_prive_global' => 'Activer le forum des rédacteurs', # MODIF
	'item_config_forums_prive_objets' => 'Activer ces forums',
	'item_desactiver_forum_administrateur' => 'Désactiver le forum des administrateurs', # MODIF
	'item_non_config_forums_prive_global' => 'Désactiver le forum des rédacteurs', # MODIF
	...
	'messages_meme_auteur' => 'Tous les messages de cet auteur', # MODIF
	...
	'messages_privadm' => 'Administrateurs', # MODIF
	...
	'titre_cadre_forum_administrateur' => 'Forum privé des administrateurs', # MODIF
